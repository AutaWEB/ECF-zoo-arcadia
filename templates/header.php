...
<body>
    <div class="header">
        ...
        <div class="col-md-3 mb-2 mb-md-0">
            ...
            <h1 style="color: white;">🐯Arcadia</h1>
            </a>
        </div>

        <ul class="head nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="../services.php" class="nav-link px-2">🔴Nos services</a></li>
            <li><a href="../habitats.php" class="nav-link px-2">🔴Les habitats</a></li>
            <li><a href="../contact.php" class="nav-link px-2">🔴Nous contacter</a></li>
        </ul>
